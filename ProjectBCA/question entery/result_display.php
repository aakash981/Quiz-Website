...
-->
    ...
    <link href="file:///C:/wamp/www/ProjectBCA/New%20folder%20(7)/index.html.css" rel="stylesheet" type="text/css">
</head>
<body  bgcolor="#E6E6FA">
...
<form method="post" action="">
	  ...
	  $s=$_POST['id'][0];
	  $b=$s+9;
       $c="select * from quiz where quizID between $s and $b";
      include('connect.php');
