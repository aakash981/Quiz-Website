...
<body><center>
<h1>Php Questions<a href="http://localhost/projectBCA/question%20entery/EDITMAIN.PHP" class="b"><br> BACK</a></h1>
<table width="1200" border="1">
  ...
  <tr>
    ...
    <td><a href="delete4.php?id=<?php echo $res['quizID']?>"><input type="button" name="button" id="button" value="Delete" /></a></td>
  </tr>
  <?php } ?>
</table></center>
</body>
