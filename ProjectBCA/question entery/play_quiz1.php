...
<div id="container">
	<center><h1><img src="Capture.PNG" width="952" height="78"></h1>
	  <a href="http://localhost/projectBCA/question%20entery/index.php"></a>
	</center>
	<a href="http://localhost/projectBCA/question%20entery/index.php" class="a">
	<H1>&nbsp;&nbsp;&nbsp;&nbsp;  BACK</H1>
     </a>
  <center><h1>Play the Quiz!</h1></center>
    <center>
    <form method="post" action="result_display1.php">
       <?php
	   error_reporting(0);
	   include("connect.php");
	   $fetch="select * from quiz1";
	   ...
	   if($a<10)
	   {
	   $rec="select * from quiz1 where quizID <'$ran' limit 10";
	   }
	   else
	   {
	   $rec="select * from quiz1 where quizID >'$ran' limit 10";
